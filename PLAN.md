...
| 2 GB fit margin (`gemma` 21, `qwen` 34) | 2026-09-14 | The earlier values fit at llama.cpp's default 1 GB margin crashed with CUDA out of memory under normal desktop use plus a spike. Costs about 13% and 9% generation speed respectively, which Casey accepted. |
