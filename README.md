...
_Generated by `./eval/promote.py` from 7 runs, 20260917T095456Z–20260917T103232Z (`eval/runs/`). Do not hand-edit: re-run the script._
...
| Agentic tools (Cline) | `lite` | Prompt ingest matters most when a tool ships large contexts: 3021 tok/s vs `gemma` 1545 and `qwen` 1020, each re-reading a ~3k-token system prompt. |
...
speed-shaped, `qwen` is the only one that reliably follows the prompt stack, and
coding and learning are ties between `gemma` and `qwen`.
